  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-white rounded-2xl w-[90%] max-w-sm p-6 shadow-xl">
        ...
        <h2 className="text-lg font-bold text-gray-800 mb-6">新しいプロジェクト</h2>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          <div>
            ...
            <input
              ...
              placeholder="例：マフラー"
              autoFocus
              className="w-full px-4 py-3 border border-gray-200 rounded-xl text-gray-800 placeholder-gray-300 focus:outline-none focus:border-[#3B82F6] focus:ring-1 focus:ring-[#3B82F6] transition-colors"
            />
          </div>
